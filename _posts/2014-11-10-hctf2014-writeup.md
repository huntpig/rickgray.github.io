...
![img]({{ site.url }}/public/ctf/hctf2014/NormalFile_img_1.jpeg)

然后简单分析了下,发现有个apk：

![img]({{ site.url }}/public/ctf/hctf2014/NormalFile_img_2.jpeg)

我就直接把classes.dex提出来看了,在⾥里⾯面发现了关键的验证算法，如下：

![img]({{ site.url }}/public/ctf/hctf2014/NormalFile_img_3.jpeg)

前⾯面还有⼀一部分,把两段合起来,不过我们不⽤用管,反正这个16位的就是最后的flag,分析了⼀一会,然后发现这⾥里⾯面的关系得不出唯⼀一得flag,没办法就去找其他线索,先把完整apk扣出来：

![img]({{ site.url }}/public/ctf/hctf2014/NormalFile_img_4.jpeg)

然后就是翻啊翻,许久之后,果然发现了⼀一点东⻄西：

![img]({{ site.url }}/public/ctf/hctf2014/NormalFile_img_5.jpeg)

这⾥里的“++”可以合刚刚源码⾥里的对应起来：

![img]({{ site.url }}/public/ctf/hctf2014/NormalFile_img_6.jpeg)
...
![img]({{ site.url }}/public/ctf/hctf2014/wow_img_2.jpeg)
